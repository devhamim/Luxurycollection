                                            ...
                                            <td>
                                                <div class="btn-group mb-1">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <?php if($product->themepage == 1): ?>
                                                            <a target="_blanck" href="<?php echo e(url('/landing/'. $product->slug)); ?>" class="dropdown-item">Preview</a>
                                                        <?php endif; ?>
                                                        <?php if($product->themepage == 2): ?>
                                                            <a target="_blanck" href="<?php echo e(url('/fashion/'. $product->slug)); ?>" class="dropdown-item">Preview</a>
                                                        <?php endif; ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nitebiz/luxurycollection.nitebiz.com/resources/views/backend/product/listproduct.blade.php ENDPATH**/ ?>