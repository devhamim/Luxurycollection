                            ...
                            <div class = "wcf-el-checkout-form cartflows-elementor__checkout-form">
                                <div id="wcf-embed-checkout-form"
                                    ...
                                    <div class="woocommerce">
                                        ...
                                        <div class="woocommerce-notices-wrapper"></div>
                                            <form action="<?php echo e(route('landing.order.store')); ?>" method="POST" class="checkout woocommerce-checkout">
                                                <?php echo csrf_field(); ?>
...
<?php /**PATH F:\all project\luxury collection\resources\views/landingpage/secondpage.blade.php ENDPATH**/ ?>