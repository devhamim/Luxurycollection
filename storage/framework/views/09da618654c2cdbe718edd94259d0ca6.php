                            ...
                            <tbody>
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sl=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($product->themepage == 2): ?>
                                        <tr>
                                            <td><?php echo e($sl+1); ?></td>
                                            <td><a target="_blanck" href="<?php echo e(url('/fashion/'. $product->slug)); ?>">https://landing.nugormart.com/<?php echo e($product->slug); ?></a></td>
                                        </tr>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nitebiz/luxurycollection.nitebiz.com/resources/views/backend/landingpage.blade.php ENDPATH**/ ?>