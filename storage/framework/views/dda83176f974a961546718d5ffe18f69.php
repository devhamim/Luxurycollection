                                ...
                                <div class="dropdown">
                                    ...
                                    <?php if($orders->first() != null): ?>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                            ...
                                            <li>
                                                <button name="status" value="<?php echo e($orders->first()->order_id .','. '1'); ?>" class="dropdown-item status">On Hold</button>
                                            </li>
                                            <li>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sl=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr id="tr_<?php echo e($order->id); ?>">
                                        ...
                                        <td class="image_copy">
                                            <?php if($order->landing == 2): ?>
                                                <img  width="100" src="<?php echo e($order->image); ?>" alt="Image" />
                                            <?php else: ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nitebiz/luxurycollection.nitebiz.com/resources/views/backend/order/listorder.blade.php ENDPATH**/ ?>