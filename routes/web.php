...
Route::get('/fashion/pakistani-baroque', [landingpageController::class, 'fashion_product'])->name('fashion.product');
Route::post('/fashion/order/store', [landingpageController::class, 'fashion_order_store'])->name('fashion.order.store');
// foreth
Route::get('/fashion/pakistani-tawakkal', [landingpageController::class, 'foreth_product'])->name('foreth.product');
Route::post('/fashion/order/store', [landingpageController::class, 'foreth_order_store'])->name('foreth.order.store');
